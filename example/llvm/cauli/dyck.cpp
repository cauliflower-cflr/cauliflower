//===- CauliflowerAndersenAA.cpp - CFL-Based Alias Analysis Implementation ------==//
//
...
char CauliflowerAndersenAA::ID = 0;

// -- Setting up/registering CFLAA pass -- //
static RegisterPass<CauliflowerAndersenAA> X("dyck-aa", "Cauliflower's CFL-R version of Andersen's analysis", true, true);
...
static void argsToEdges(CauliflowerAndersenAA &, Instruction *,
...
// given function
static void buildGraphFrom(CauliflowerAndersenAA &, Function *,
